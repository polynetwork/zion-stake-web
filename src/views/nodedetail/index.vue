<template>
  <div class="nodedetail">
    <div class="path">
      ...
      <span class="back" @click="goPage('/')">Home</span>
      <div class="pathline"></div>
      <span class="registerpath">Node Detail </span>
    </div>
    <div class="line"></div>
    <basic :nodeDetail="nodeDetail" @update="updateNode()"></basic>
    <stakeuser :nodeDetail="nodeDetail"></stakeuser>
  </div>
</template>

<script>
import basic from './basic.vue'
import stakeuser from './stakeuser.vue'
export default {
  name: 'NodeDetailView',
  components: {
    basic,
